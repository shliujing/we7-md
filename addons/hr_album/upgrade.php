...
if(!pdo_indexexists('hr_album_ads',  'indx_id')) {
	pdo_query("ALTER TABLE ".tablename('hr_album_ads')." ADD KEY `indx_id` (`id`);");
}
if(!pdo_indexexists('hr_album_ads',  'indx_uniacid')) {
...
if(!pdo_indexexists('hr_album_app',  'indx_id')) {
	pdo_query("ALTER TABLE ".tablename('hr_album_app')." ADD KEY `indx_id` (`id`);");
}
if(!pdo_indexexists('hr_album_app',  'indx_uniacid')) {
...
if(!pdo_indexexists('hr_album_data',  'index_uniacid')) {
	pdo_query("ALTER TABLE ".tablename('hr_album_data')." ADD KEY `index_uniacid` (`uniacid`);");
}
if(!pdo_indexexists('hr_album_data',  'index_openid')) {
...
if(!pdo_indexexists('hr_album_formdata',  'indx_id')) {
...
if(!pdo_indexexists('hr_album_sended',  'indx_id')) {
...
if(!pdo_indexexists('hr_album_user',  'index_uniacid')) {
	pdo_query("ALTER TABLE ".tablename('hr_album_user')." ADD KEY `index_uniacid` (`uniacid`);");
}
if(!pdo_indexexists('hr_album_user',  'index_openid')) {
