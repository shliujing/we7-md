...
<input type="hidden" name="id" value="<?php  echo $music['id'];?>">
  <div class="layui-form-item">
    ...
    <div class="layui-input-block">
      <input type="text" name="musictitle"  lay-verify="required" value="<?php  echo $music['title'];?>"  placeholder="请输入歌曲名称，十个字符以下最佳" autocomplete="off" class="layui-input">
    </div>
  </div>
  <div class="layui-form-item">
    <label class="layui-form-label">歌手：</label>
    <div class="layui-input-block">
      <input type="text" name="singer"  lay-verify="required"  value="<?php  echo $music['singer'];?>" placeholder="请输入歌手名字，十个字符以下最佳" autocomplete="off" class="layui-input">
    </div>
  </div>
  <div class="layui-form-item">
          ...
          <div class="layui-input-block">
            <select name="musictype" lay-verify="required">
              <?php  if(is_array($cate)) { foreach($cate as $item) { ?>
              	<option value="<?php  echo $item['id'];?>" <?php  if($item['id'] == $music['type']) { ?>selected<?php  } ?>><?php  echo $item['title'];?></option>	
              <?php  } } ?>			  
            </select>
          </div>
        </div>
  <div class="layui-form-item">
    ...
    <div class="layui-input-block">
      <input id="bgmusic" style="width:50%;float:left" type="text" name="musicurl" value="<?php  echo $music['music'];?>"  placeholder="选择上传的音频文件或直接输入URL地址，常用格式：mp3 " autocomplete="off" class="layui-input">
