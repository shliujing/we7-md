...
<body>
<form class="layui-form layui-form-pane" style="padding:20px;" action="<?php  echo url('site/entry/index', array('m' => 'hr_album','op' => 'edit'));?>" method="post">
<input type="hidden" name="id" value="<?php  echo $item['id'];?>">
  <div class="layui-form-item">
    <label class="layui-form-label">分类排序：</label>
    <div class="layui-input-block">
      <input type="text" name="displayorder"  lay-verify="required" value="<?php  echo $item['displayorder'];?>"  placeholder="数值越大越靠前" autocomplete="off" class="layui-input">
    </div>
  </div>
  <div class="layui-form-item">
