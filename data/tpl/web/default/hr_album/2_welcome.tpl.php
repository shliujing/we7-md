...
<div id="win10">
    ...
    <div class="desktop">
        <div id="win10-shortcuts">
            ...
            <div class="shortcut" onclick="Win10.openUrl('<?php  echo $_W['siteroot'];?>web/index.php?c=site&a=entry&do=index&m=hr_album','首页管理')">
                <div class="icon"><img src="<?php  echo $_W['siteroot'];?>addons/hr_album/style/images/manage/icon/index.png"/></div>
