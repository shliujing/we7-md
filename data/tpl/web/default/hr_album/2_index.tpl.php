...
<a href="<?php  echo $_W['siteroot'];?>web/index.php?c=site&a=entry&do=index&op=edit&m=hr_album" class="layui-btn" style="float: right;margin-bottom: 10px;margin-right:10px;">添加首页分类</a>
	...
	layui.use('layer', function(){
		  ...
		  layer.confirm('确定删除此音乐分类么？', {
			  ...
			  //layer.msg('的确很重要', {icon: 1});
				$.post("<?php  echo $_W['siteroot'];?>web/index.php?c=site&a=entry&do=index&m=hr_album&op=delincate",{id:pid}, function(data) {
